        ...
        <div class="school-basic-info">
          ...
          <div class="basic-info-grid">
            ...
            <div class="info-item">
              ...
              <span class="info-value">{{ schoolDetail.f211 ? '是' : '否' }}</span>
            </div>
            <div class="info-item">
              <span class="info-label">985:</span>
              <span class="info-value">{{ schoolDetail.f985 ? '是' : '否' }}</span>
            </div>
            <div class="info-item">
...
<script setup>
import BaiduMap from "@/views/new_zxwl/components/baiduMap.vue"
import ChinaMap from "@/views/new_zxwl/components/chinaMap.vue"
// 添加新的引用
