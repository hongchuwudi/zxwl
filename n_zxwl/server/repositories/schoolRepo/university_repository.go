...
func (r *UniversityRepository) GetDetailByID(id int) (*sqlModel2.UniversityDetailResponse, error) {
	var response sqlModel2.UniversityDetailResponse
...
func (r *UniversityRepository) GetByID(id int) (*sqlModel2.UniversitiesDetail, error) {
	var university sqlModel2.UniversitiesDetail
...
func (r *UniversityRepository) GetCollegesBySchoolID(schoolID int) ([]sqlModel2.UniversitiesCollegesDepartments, error) {
	var colleges []sqlModel2.UniversitiesCollegesDepartments
...
func (r *UniversityRepository) GetDisciplineRankingsBySchoolID(schoolID int) ([]sqlModel2.UniversitiesDisciplineRankings, error) {
	var rankings []sqlModel2.UniversitiesDisciplineRankings
...
func (r *UniversityRepository) GetDualClassSubjectsBySchoolID(schoolID int) ([]sqlModel2.UniversitiesDualClassSubjects, error) {
	var subjects []sqlModel2.UniversitiesDualClassSubjects
	err := r.db.Where("school_id = ?", schoolID).Find(&subjects).Error
	return subjects, err
}

// GetVideosBySchoolID 获取院校的视频信息
func (r *UniversityRepository) GetVideosBySchoolID(schoolID int) ([]sqlModel2.UniversityVideo, error) {
	var videos []sqlModel2.UniversityVideo
...
func (r *UniversityRepository) GetSpecialProgramsBySchoolID(schoolID int) ([]sqlModel2.UniversitiesSpecialPrograms, error) {
...
func (r *UniversityRepository) GetAdmissionScoresBySchoolID(schoolID int) ([]sqlModel2.AdmissionUniversities, error) {
	var scores []sqlModel2.AdmissionUniversities
	err := r.db.Where("school_id = ?", schoolID).Order("year DESC, province_id").Find(&scores).Error
	return scores, err
}

// GetSpecialProgramsWithFilter 根据条件筛选院校专业信息
func (r *UniversityRepository) GetSpecialProgramsWithFilter(schoolID int, filters map[string]interface{}) ([]sqlModel2.UniversitiesSpecialPrograms, error) {
...
func (r *UniversityRepository) GetAdmissionScoresByProvince(schoolID, provinceID int) ([]sqlModel2.AdmissionUniversities, error) {
	var scores []sqlModel2.AdmissionUniversities
...
// GetByIDs 批量获取院校基础信息
func (r *UniversityRepository) GetByIDs(ids []int) ([]sqlModel2.UniversitiesDetail, error) {
	var universities []sqlModel2.UniversitiesDetail
	err := r.db.Where("id IN ?", ids).Find(&universities).Error
	return universities, err
}

// GetByProvince 根据省份获取院校列表
func (r *UniversityRepository) GetByProvince(provinceID int) ([]sqlModel2.UniversitiesDetail, error) {
	var universities []sqlModel2.UniversitiesDetail
...
func (r *UniversityRepository) GetBySpecialAndScore(specialID int, minScore uint16) ([]sqlModel2.UniversitiesDetail, error) {
	var universities []sqlModel2.UniversitiesDetail
...
func (r *UniversityRepository) GetByName(name string) ([]sqlModel2.UniversitiesDetail, error) {
	var universities []sqlModel2.UniversitiesDetail
