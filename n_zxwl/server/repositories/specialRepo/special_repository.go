...
func (r *SpecialRepository) GetDetailByID(id int) (*sqlModel2.SpecialDetailResponse, error) {
	var response sqlModel2.SpecialDetailResponse
	...
	// 查询专业名校示例
	var famousSchools []sqlModel2.SpecialFamousSchool
	...
	// 查询专业就业分布
	var jobDistributions []sqlModel2.SpecialJobDistribution
	...
	// 查询专业薪资数据
	var salaryData []sqlModel2.SpecialSalaryData
	...
	// 查询开设该专业的院校信息
	var universitySpecialInfo []sqlModel2.UniversitiesSpecialPrograms
...
func (r *SpecialRepository) GetByID(id int) (*sqlModel2.SpecialDetail, error) {
	var special sqlModel2.SpecialDetail
...
func (r *SpecialRepository) GetByCode(code string) (*sqlModel2.SpecialDetail, error) {
	var special sqlModel2.SpecialDetail
...
func (r *SpecialRepository) GetByName(name string) ([]sqlModel2.SpecialDetail, error) {
	var specials []sqlModel2.SpecialDetail
...
func (r *SpecialRepository) GetContentsBySpecialID(specialID int) ([]sqlModel2.SpecialContent, error) {
	var contents []sqlModel2.SpecialContent
...
func (r *SpecialRepository) GetEmploymentRatesBySpecialID(specialID string) ([]sqlModel2.SpecialEmploymentRate, error) {
	var rates []sqlModel2.SpecialEmploymentRate
...
func (r *SpecialRepository) GetFamousSchoolsBySpecialID(specialID string) ([]sqlModel2.SpecialFamousSchool, error) {
	var schools []sqlModel2.SpecialFamousSchool
...
func (r *SpecialRepository) GetVideosBySpecialID(specialID int) ([]sqlModel2.SpecialVideo, error) {
	var videos []sqlModel2.SpecialVideo
...
func (r *SpecialRepository) GetImpressionTagsBySpecialID(specialID string) ([]sqlModel2.SpecialImpressionTag, error) {
	var tags []sqlModel2.SpecialImpressionTag
...
func (r *SpecialRepository) GetJobDistributionsBySpecialID(specialID string) ([]sqlModel2.SpecialJobDistribution, error) {
	var distributions []sqlModel2.SpecialJobDistribution
...
func (r *SpecialRepository) GetSalaryDataBySpecialID(specialID string) ([]sqlModel2.SpecialSalaryData, error) {
	var salaryData []sqlModel2.SpecialSalaryData
...
func (r *SpecialRepository) GetUniversitySpecialInfoBySpecialID(specialID int) ([]sqlModel2.UniversitiesSpecialPrograms, error) {
	var programs []sqlModel2.UniversitiesSpecialPrograms
...
func (r *SpecialRepository) GetByInterest(keyword string) ([]sqlModel2.SpecialDetail, error) {
	var specials []sqlModel2.SpecialDetail
...
func (r *SpecialRepository) GetHotSpecials(limit int) ([]sqlModel2.SpecialDetail, error) {
	var specials []sqlModel2.SpecialDetail
...
func (r *SpecialRepository) GetByLevel(level string) ([]sqlModel2.SpecialDetail, error) {
	var specials []sqlModel2.SpecialDetail
...
func (r *SpecialRepository) GetByType(specialType string) ([]sqlModel2.SpecialDetail, error) {
	var specials []sqlModel2.SpecialDetail
...
// GetByIDs 批量获取专业基础信息
func (r *SpecialRepository) GetByIDs(ids []int) ([]sqlModel2.SpecialDetail, error) {
	var specials []sqlModel2.SpecialDetail
...
func (r *SpecialRepository) GetBySalaryRange(minSalary, maxSalary int) ([]sqlModel2.SpecialDetail, error) {
	var specials []sqlModel2.SpecialDetail
...
func (r *SpecialRepository) GetByEmploymentRate(minRate float64) ([]sqlModel2.SpecialDetail, error) {
	var specials []sqlModel2.SpecialDetail
...
func (r *SpecialRepository) GetAllSpecialDetails() ([]sqlModel2.SpecialDetail, error) {
	var specials []sqlModel2.SpecialDetail
...
func (r *SpecialRepository) GetAllSpecialDetailsWithPagination(page, pageSize int, filters map[string]interface{}) ([]sqlModel2.SpecialDetail, int64, error) {
	var specials []sqlModel2.SpecialDetail
	var total int64
...
func (r *SpecialRepository) GetAllSpecialDetailsWithFilter(filters map[string]interface{}) ([]sqlModel2.SpecialDetail, error) {
	query := r.db.Table("special_detail")
...
func (r *SpecialRepository) GetProfessionalList(filters map[string]interface{}) ([]sqlModel2.SpecialDetail, error) {
	var specials []sqlModel2.SpecialDetail
